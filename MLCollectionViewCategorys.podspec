#
#  Be sure to run `pod spec lint MLCollectionViewCategorys.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "yanglei"
  # s.authors            = { "yanglei" => "598090063@qq.com" }
  # s.social_media_url   = "http://twitter.com/yanglei"
